export const L1BitcoinRedeemerABI = [
  {
    "anonymous": false,
    "inputs": [
      {"indexed": true, "internalType": "bytes32", "name": "l2Identifier", "type": "bytes32"},
      {"indexed": true, "internalType": "bytes32", "name": "walletPubKeyHash", "type": "bytes32"},
      {"indexed": false, "internalType": "bytes", "name": "redeemerOutputScript", "type": "bytes"},
      {"indexed": false, "internalType": "uint64", "name": "requestedAmount", "type": "uint64"},
      {"indexed": false, "internalType": "uint64", "name": "treasuryFee", "type": "uint64"},
      {"indexed": false, "internalType": "uint64", "name": "txMaxFee", "type": "uint64"},
