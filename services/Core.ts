...
// Providers
// ---------------------------------------------------------------
export const providerL2: ethers.providers.JsonRpcProvider = new ethers.providers.JsonRpcProvider(chainConfig.l2Rpc);
export const providerL1: ethers.providers.JsonRpcProvider = new ethers.providers.JsonRpcProvider(chainConfig.l1Rpc);

// ---------------------------------------------------------------
// Signers
// ---------------------------------------------------------------
export const signerL2: ethers.Wallet = new ethers.Wallet(chainConfig.privateKey, providerL2);
export const signerL1: ethers.Wallet = new ethers.Wallet(chainConfig.privateKey, providerL1);
...
export const TBTCVault: ethers.Contract = new ethers.Contract(chainConfig.vaultAddress, TBTCVaultABI, signerL1);
...
const TBTCVaultProvider = new ethers.Contract(chainConfig.vaultAddress, TBTCVaultABI, providerL1);
...
export const initializeChain = async () => {
	try {
		...
		LogMessage(`Chain handler for ${chainConfig.chainName} successfully initialized`);
		return true;
	} catch (error) {
