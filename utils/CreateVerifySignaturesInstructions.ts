...
import { createReadOnlyWormholeProgramInterface, deriveGuardianSetKey, getGuardianSet } from '@certusone/wormhole-sdk/lib/cjs/solana/wormhole/index.js';
...
export async function createVerifySignaturesInstructions(
  ...
  console.log("wormholeProgramId", wormholeProgramId);
